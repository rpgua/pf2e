...
description: Feat - Witch’s Bottle Фіт - Witch’s Bottle
sidebar:
    order: 849
---
...
<Feat title={"Witch’s Bottle"} traits={[['Witch']]} pfs={"Standard"} level={8} url={"https://2e.aonprd.com/Feats.aspx?ID=5008"}>
