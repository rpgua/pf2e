---
title: Sacred Ground
description: Feat - Sacred Ground Фіт - Sacred Ground
sidebar:
    order: 634
---
...
<Feat title={"Sacred Ground"} traits={[['Cleric'], ['Consecration'], ['Divine'], ['Exploration']]} pfs={"Standard"} level={4} url={"https://2e.aonprd.com/Feats.aspx?ID=4660"}>
