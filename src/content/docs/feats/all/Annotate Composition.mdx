...
description: Feat - Annotate Composition Фіт - Annotate Composition
sidebar:
    order: 40
---
...
<Feat title={"Annotate Composition"} traits={[['Bard'], ['Exploration'], ['Linguistic']]} pfs={"Standard"} level={10} url={"https://2e.aonprd.com/Feats.aspx?ID=4610"}>
