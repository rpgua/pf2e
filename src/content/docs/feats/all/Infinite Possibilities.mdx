...
description: Feat - Infinite Possibilities Фіт - Infinite Possibilities
sidebar:
    order: 388
---
...
<Feat title={"Infinite Possibilities"} traits={[['Wizard']]} pfs={"Standard"} level={18} url={"https://2e.aonprd.com/Feats.aspx?ID=5050"}>
