...
description: Feat - Spell Combination Фіт - Spell Combination
sidebar:
    order: 704
---
...
<Feat title={"Spell Combination"} traits={[['Wizard']]} pfs={"Standard"} level={20} url={"https://2e.aonprd.com/Feats.aspx?ID=5054"}>
