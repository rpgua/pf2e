...
description: Feat - Musical Instrument Фіт - Musical Instrument
sidebar:
    order: 155
---
...
<Equipment title={"Musical Instrument"} traits={[]} level={0} url={"https://2e.aonprd.com/Equipment.aspx?ID=2737"} bulk={0} >
