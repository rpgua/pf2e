---
title: Tool (Long)
description: Feat - Tool (Long) Фіт - Tool (Long)
sidebar:
    order: 242
---
...
<Equipment title={"Tool (Long)"} traits={[]} pfs={"Standard"} level={0} url={"https://2e.aonprd.com/Equipment.aspx?ID=2759"} price={100} bulk={1} hands={"2"} >
