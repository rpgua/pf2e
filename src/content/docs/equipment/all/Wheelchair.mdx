---
title: Wheelchair
description: Feat - Wheelchair Фіт - Wheelchair
sidebar:
    order: 258
---
...
<Equipment title={"Wheelchair"} traits={[]} pfs={"Standard"} level={0} url={"https://2e.aonprd.com/Equipment.aspx?ID=2777"} price={50} bulk={2} >
