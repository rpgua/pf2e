...
description: Feat - Barding (Heavy; Large) Фіт - Barding (Heavy; Large)
sidebar:
    order: 12
---
...
<Equipment title={"Barding (Heavy; Large)"} traits={[]} pfs={"Standard"} level={0} url={"https://2e.aonprd.com/Equipment.aspx?ID=2778"} price={5000} bulk={8} >
