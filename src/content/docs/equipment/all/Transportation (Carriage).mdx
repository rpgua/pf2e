...
description: Feat - Transportation (Carriage) Фіт - Transportation (Carriage)
sidebar:
    order: 248
---
...
<Equipment title={"Transportation (Carriage)"} traits={[]} pfs={"Standard"} level={0} url={"https://2e.aonprd.com/Equipment.aspx?ID=2770"} price={20} bulk={0} >
