---
title: Clothing (Fine)
description: Feat - Clothing (Fine) Фіт - Clothing (Fine)
sidebar:
    order: 47
---
...
<Equipment title={"Clothing (Fine)"} traits={[]} pfs={"Standard"} level={0} url={"https://2e.aonprd.com/Equipment.aspx?ID=2715"} price={200} bulk={0.1} >
