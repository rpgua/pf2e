---
title: Clothing (Explorer's)
description: Feat - Clothing (Explorer's) Фіт - Clothing (Explorer's)
sidebar:
    order: 46
---
...
<Equipment title={"Clothing (Explorer's)"} traits={[]} pfs={"Standard"} level={0} url={"https://2e.aonprd.com/Equipment.aspx?ID=2715"} price={10} bulk={0.1} >
