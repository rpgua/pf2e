...
description: Feat - Spellcasting (5th level) Фіт - Spellcasting (5th level)
sidebar:
    order: 211
---
...
<Equipment title={"Spellcasting (5th level)"} traits={[]} pfs={"Standard"} level={0} url={"https://2e.aonprd.com/Equipment.aspx?ID=2771"} price={8000} bulk={0} >
