...
description: Feat - Spellcasting (8th level) Фіт - Spellcasting (8th level)
sidebar:
    order: 214
---
...
<Equipment title={"Spellcasting (8th level)"} traits={[]} pfs={"Standard"} level={0} url={"https://2e.aonprd.com/Equipment.aspx?ID=2771"} price={72000} bulk={0} >
