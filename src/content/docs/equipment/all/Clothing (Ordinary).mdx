...
description: Feat - Clothing (Ordinary) Фіт - Clothing (Ordinary)
sidebar:
    order: 49
---
...
<Equipment title={"Clothing (Ordinary)"} traits={[]} pfs={"Standard"} level={0} url={"https://2e.aonprd.com/Equipment.aspx?ID=2715"} price={10} bulk={0} >
