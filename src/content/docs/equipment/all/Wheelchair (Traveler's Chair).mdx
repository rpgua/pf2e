...
description: Feat - Wheelchair (Traveler's Chair) Фіт - Wheelchair (Traveler's Chair)
sidebar:
    order: 259
---
...
<Equipment title={"Wheelchair (Traveler's Chair)"} traits={[]} pfs={"Standard"} level={0} url={"https://2e.aonprd.com/Equipment.aspx?ID=2777"} price={500} bulk={3} >
