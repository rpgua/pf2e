...
description: Feat - Clothing (High-Fashion Fine) Фіт - Clothing (High-Fashion Fine)
sidebar:
    order: 48
---
...
<Equipment title={"Clothing (High-Fashion Fine)"} traits={[]} pfs={"Standard"} level={3} url={"https://2e.aonprd.com/Equipment.aspx?ID=2715"} price={5500} bulk={0.1} >
