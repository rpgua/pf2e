...
description: Feat - Musical Instrument (Heavy) Фіт - Musical Instrument (Heavy)
sidebar:
    order: 157
---
...
<Equipment title={"Musical Instrument (Heavy)"} traits={[]} pfs={"Standard"} level={0} url={"https://2e.aonprd.com/Equipment.aspx?ID=2737"} price={200} bulk={16} hands={"2"} >
