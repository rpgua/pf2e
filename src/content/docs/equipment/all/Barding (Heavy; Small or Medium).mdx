...
description: Feat - Barding (Heavy; Small or Medium) Фіт - Barding (Heavy; Small or Medium)
sidebar:
    order: 13
---
...
<Equipment title={"Barding (Heavy; Small or Medium)"} traits={[]} pfs={"Standard"} level={2} url={"https://2e.aonprd.com/Equipment.aspx?ID=2778"} price={2500} bulk={4} >
