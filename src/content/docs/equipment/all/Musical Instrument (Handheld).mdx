...
description: Feat - Musical Instrument (Handheld) Фіт - Musical Instrument (Handheld)
sidebar:
    order: 156
---
...
<Equipment title={"Musical Instrument (Handheld)"} traits={[]} pfs={"Standard"} level={0} url={"https://2e.aonprd.com/Equipment.aspx?ID=2737"} price={80} bulk={1} hands={"2"} >
