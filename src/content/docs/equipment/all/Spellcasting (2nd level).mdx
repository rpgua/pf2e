...
description: Feat - Spellcasting (2nd level) Фіт - Spellcasting (2nd level)
sidebar:
    order: 208
---
...
<Equipment title={"Spellcasting (2nd level)"} traits={[]} pfs={"Standard"} level={0} url={"https://2e.aonprd.com/Equipment.aspx?ID=2771"} price={700} bulk={0} >
