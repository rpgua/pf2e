...
description: Feat - Transportation (Caravan) Фіт - Transportation (Caravan)
sidebar:
    order: 247
---
...
<Equipment title={"Transportation (Caravan)"} traits={[]} pfs={"Standard"} level={0} url={"https://2e.aonprd.com/Equipment.aspx?ID=2770"} price={3} bulk={0} >
