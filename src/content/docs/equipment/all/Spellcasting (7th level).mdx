...
description: Feat - Spellcasting (7th level) Фіт - Spellcasting (7th level)
sidebar:
    order: 213
---
...
<Equipment title={"Spellcasting (7th level)"} traits={[]} pfs={"Standard"} level={0} url={"https://2e.aonprd.com/Equipment.aspx?ID=2771"} price={36000} bulk={0} >
