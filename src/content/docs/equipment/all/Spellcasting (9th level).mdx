...
description: Feat - Spellcasting (9th level) Фіт - Spellcasting (9th level)
sidebar:
    order: 215
---
...
<Equipment title={"Spellcasting (9th level)"} traits={[]} pfs={"Standard"} level={0} url={"https://2e.aonprd.com/Equipment.aspx?ID=2771"} price={180000} bulk={0} >
