...
description: Feat - Barding (Light; Small or Medium) Фіт - Barding (Light; Small or Medium)
sidebar:
    order: 15
---
...
<Equipment title={"Barding (Light; Small or Medium)"} traits={[]} pfs={"Standard"} level={0} url={"https://2e.aonprd.com/Equipment.aspx?ID=2778"} price={1000} bulk={2} >
