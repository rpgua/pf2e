...
description: Feat - Spellcasting (3rd level) Фіт - Spellcasting (3rd level)
sidebar:
    order: 209
---
...
<Equipment title={"Spellcasting (3rd level)"} traits={[]} pfs={"Standard"} level={0} url={"https://2e.aonprd.com/Equipment.aspx?ID=2771"} price={1800} bulk={0} >
