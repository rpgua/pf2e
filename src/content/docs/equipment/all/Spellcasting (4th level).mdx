...
description: Feat - Spellcasting (4th level) Фіт - Spellcasting (4th level)
sidebar:
    order: 210
---
...
<Equipment title={"Spellcasting (4th level)"} traits={[]} pfs={"Standard"} level={0} url={"https://2e.aonprd.com/Equipment.aspx?ID=2771"} price={4000} bulk={0} >
