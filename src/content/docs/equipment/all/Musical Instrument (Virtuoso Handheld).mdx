...
description: Feat - Musical Instrument (Virtuoso Handheld) Фіт - Musical Instrument (Virtuoso Handheld)
sidebar:
    order: 158
---
...
<Equipment title={"Musical Instrument (Virtuoso Handheld)"} traits={[]} pfs={"Standard"} level={3} url={"https://2e.aonprd.com/Equipment.aspx?ID=2737"} price={5000} bulk={1} hands={"2"} >
