...
description: Feat - Transportation (Ferry or Riverboat) Фіт - Transportation (Ferry or Riverboat)
sidebar:
    order: 249
---
...
<Equipment title={"Transportation (Ferry or Riverboat)"} traits={[]} pfs={"Standard"} level={0} url={"https://2e.aonprd.com/Equipment.aspx?ID=2770"} price={4} bulk={0} >
