---
title: Spellcasting (6th level)
description: Feat - Spellcasting (6th level) Фіт - Spellcasting (6th level)
sidebar:
    order: 212
---
...
<Equipment title={"Spellcasting (6th level)"} traits={[]} pfs={"Standard"} level={0} url={"https://2e.aonprd.com/Equipment.aspx?ID=2771"} price={16000} bulk={0} >
