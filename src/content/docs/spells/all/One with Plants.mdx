...
description: Spell - One with Plants Чара - One with Plants
sidebar:
    order: 275
---
...
<Spell title={"One with Plants"} traits={[['Concentrate'], ['Manipulate'], ['Plant'], ['Polymorph'], ['Wood']]} action={2} pfs={"Standard"} level={2} url={"https://2e.aonprd.com/Spells.aspx?ID=1618"} duration={600} element={['Wood']} legacy_name={"Tree Shape"} source={['Player Core pg. 347']} spell_type={"Spell"} tradition={['Primal']} type={"Spell"}>
