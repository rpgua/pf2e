...
description: Spell - Retrocognition Чара - Retrocognition
sidebar:
    order: 334
---
...
<Spell title={"Retrocognition"} traits={[['Concentrate'], ['Manipulate']]} action={60} pfs={"Standard"} level={7} url={"https://2e.aonprd.com/Spells.aspx?ID=1652"} component={['1 minute']} source={['Player Core pg. 353']} spell_type={"Spell"} tradition={['Arcane', 'Occult']} type={"Spell"}>
