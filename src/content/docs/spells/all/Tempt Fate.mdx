---
title: Tempt Fate
description: Spell - Tempt Fate Чара - Tempt Fate
sidebar:
    order: 426
---
...
<Spell title={"Tempt Fate"} traits={[['Uncommon', 3], ['Cleric'], ['Focus'], ['Fortune'], ['Manipulate']]} action={4} pfs={"Standard"} level={4} url={"https://2e.aonprd.com/Spells.aspx?ID=1803"} domain={['Fate']} range={120} source={['Player Core pg. 375']} spell_type={"Focus"} target={"the triggering creature"} trigger={"You or an ally within range attempts a saving throw"} type={"Spell"}>
