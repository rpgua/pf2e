---
title: Переклад Composition
description: Trait - Composition Риса - Composition
sidebar:
    order: 32
---
...
<Trait title={"Composition"} traits={[['Composition']]} url={"https://2e.aonprd.com/Traits.aspx?ID=559"}>
