---
title: Переклад Possession
description: Trait - Possession Риса - Possession
sidebar:
    order: 124
---
...
<Trait title={"Possession"} traits={[['Possession']]} url={"https://2e.aonprd.com/Traits.aspx?ID=671"}>
