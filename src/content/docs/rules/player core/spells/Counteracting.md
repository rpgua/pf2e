...
__Critical Success__ Counteract the target if its counteract rank is no more than 3 higher than your effect's counteract rank.
__Success__ Counteract the target if its counteract rank is no more than 1 higher than your effect's counteract rank.
__Failure__ Counteract the target if its counteract rank is lower than your effect's counteract rank.
__Critical Failure__ You fail to counteract the target.
